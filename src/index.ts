...
epub?.file('package.opf',`<?xml version="1.0" encoding="UTF-8"?>
...
css?.file('epub-spec.css',`@charset "utf-8";
...
img?.file('epub_logo_color.jpg',await (await fetch('https://raw.githubusercontent.com/IDPF/epub3-samples/main/30/epub30-spec/EPUB/img/epub_logo_color.jpg')).arrayBuffer())

const xhtml = epub?.folder("xhtml");

xhtml?.file('epub30-nav.xhtml',`<?xml version="1.0" encoding="utf-8"?>
...
xhtml?.file('epub30-changes.xhtml',`<?xml version="1.0" encoding="utf-8"?>
