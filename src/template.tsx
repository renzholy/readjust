        ...
        <nav {...epub_type('toc')} id="toc">
          ...
          <ol>
              ...
              <ol>
                ...
                <li>
                  ...
                  <ol>
                    ...
                    <li>
                      <a href="epub30-overview.xhtml#sec-nav">
                        2.2. Navigation
                      </a>
                      <ol>
                        <li>
                    ...
                    <li>
                      <a href="epub30-overview.xhtml#sec-linking">
                        2.3. Linking
                      </a>
                    </li>
                    <li>
                ...
                <li>
                  ...
                  <ol>
                    ...
                    <li>
                      <a href="epub30-overview.xhtml#sec-gls-fonts">
                        3.4. Fonts
                      </a>
                    </li>
                    <li>
            ...
            <li id="pub">
              ...
              <ol>
                <li>
                  <a href="epub30-publications.xhtml#sec-overview">
                    1. Overview
                  </a>
                  <ol>
                    <li>
                      ...
                      <ol>
                        ...
                        <li>
                          <a href="epub30-publications.xhtml#sec-manifest-elem">
                            3.4.10. The{' '}
                            <code className="literal">manifest</code> Element
                          </a>
                        </li>
                        <li>
            ...
            <li id="cd">
              ...
              <ol>
                <li>
                  <a href="epub30-contentdocs.xhtml#sec-overview">
                    1. Overview
                  </a>
                  <ol>
                    <li>
                              ...
                              <ol>
                                ...
                                <li>
                                  <a href="epub30-contentdocs.xhtml#sec-cd-ssml-ph-attrib">
                                    2.1.3.2.2. The <code>ssml:ph</code>{' '}
                                    attribute
                                  </a>
                                </li>
                                <li>
                                  ...
                                  <ol>
                                    ...
                                    <li>
                                      <a href="epub30-contentdocs.xhtml#sec-xhtml-epub-default">
                                        2.1.3.3.2.3. The{' '}
                                        <code>epub:default</code> Element
                                      </a>
                                    </li>
                                  </ol>
                                </li>
                ...
                <li>
                  <a href="epub30-contentdocs.xhtml#sec-pls">
                    4. PLS Documents
                  </a>
                  <ol>
                    <li>
...
export const example_changes = render_html(
  render_to_string(
    <>
      <head>
        <meta charSet="utf-8" />
      ...
      <body className="prose">
        ...
        <div className="legal">
          ...
          <div className="legalnotice" title="Legal Notice">
            ...
            <p>
              ...
              United States Code. Reproduction and dissemination of this work
              with changes is prohibited except with the written permission of
              the{' '}
          ...
          <ol>
            ...
            <li>
              <ol>
                ...
                <li>
                  <a href="#sec-new-changed-xml-unicode">
                    3.11. XML and Unicode
                  </a>
                </li>
              </ol>
        ...
        >
          ...
          <p>
            EPUB® is an interchange and delivery format for digital
            publications, based on XML and Web Standards. An EPUB Publication
            can be thought of as a reliable packaging of Web content that
            represents a digital book, magazine, or other type of publication,
            and able to distributed for online and offline consumption.{' '}
          </p>
          <p>
            This document, EPUB 3 Changes from EPUB 2.0.1, describes changes
            made in the third major revision of EPUB, including some rationale
            for the changes, and some guidance for content authors and Reading
            System developers regarding backwards compatibility considerations.
          </p>
          <p>
          ...
          <p>
            Unless otherwise specified, terms used herein have the meaning
          ...
          >
            ...
            <p>
              EPUB had its roots in the interchange format known as the Open
              EBook Publication Structure (OEBPS). OEBPS 1.0 was approved in
              1999 by the Open eBook Forum, an organization that later became
              the International Digital Publishing Forum (IDPF). Subsequent
              revisions 1.1 and 1.2 were approved by the IDPF in 2001 and 2002
              respectively.
            </p>
            <p>
              {' '}
              It was realized that a need existed for a format standard that
              could be used for delivery as well as interchange, and work began
              in late 2005 on a single-file container format for OEPBS, which
              was approved by the IDPF as the OEBPS Container Format (OCF) in
              2006. Work on a 2.0 revision of OEBPS began in parallel which was
              approved as the renamed EPUB 2.0 in October, 2007, consisting of a
              triumvirate of specifications: Open Package Format (OPF), Open
              Publication Format (OPF) together with OCF. EPUB 2.0.1, a
              maintenance update to the 2.0 specification set primarily intended
              clarify and correct errata in the specifications, was approved in
              September, 2010.{' '}
              <a
                className="biblioref"
        ...
        >
          ...
          <p>
            ...
            and certain terminology changes have been made to improve clarity.
          ...
          >
            ...
            <p>
              Maintaining consistent use of terminology from EPUB 2.0.1 to EPUB
              3 was a consideration during development, but changes in document
              organization, feature set and conformance requirements inevitably
              resulted in a number of changes.
            </p>
            <p>
              Each specification contains a Terminology section near the top
              that defines and explains the new terms (e.g.,{' '}
        ...
        >
          ...
          >
            ...
            >
              ...
              <p>
                SVG documents can now appear in the spine in EPUB 3 (i.e., SVG
                no longer needs to be nested within an XHTML document).
              </p>
            </section>
            <section
              className="section"
            ...
            >
              ...
              <p>
                A method for inflecting domain-specific semantics in XHTML
                Content Documents using attributes has been added. Refer to{' '}
                <span className="phrase">
                  <a href="epub30-contentdocs.xhtml#sec-xhtml-semantic-inflection">
                    Semantic Inflection
                  </a>{' '}
            ...
            >
              ...
              <p>
                ...
                the <code>requiredModules</code> attribute. This simplification
                is backwards compatible with existing EPUB 2 Reading System
          ...
          >
            ...
            <p>
              ...
              publication-wide navigation information via a specialized
            ...
            <p>
              While NCX support was optional for EPUB2 Reading Systems,
              inclusion of and support for EPUB Navigation Documents is required
              in EPUB 3.
            </p>
            <p>
              As noted in{' '}
              ...
              , EPUB 3 Publications may include the EPUB 2 NCX for EPUB 2
              Reading System forward compatibility purposes.
            </p>
          </section>
          <section
            className="section"
          ...
          >
            ...
            >
              ...
              <p>
                EPUB 3 Reading Systems may optionally support scripting, which
                was explicitly discouraged in EPUB 2. Scripted content{' '}
                <span className="phrase">
            ...
            >
              ...
              <p>
                ...
                that allows declarative binding of activation events from image
                or textual elements to properties of audio and video players
                (e.g., play, stop, pause).
              </p>
            </section>
            <section
          ...
          >
            ...
            >
              ...
              <p>
                ...
                alternate viewing modes, such as day/night and
            ...
            >
              ...
              <p>
                ...
                has been added the Open Container Format specification. This
                issue was previously outlined in{' '}
          ...
          >
            ...
            >
              ...
              <p>
                ...
                that all Reading Systems that support audio playback must
                support MP3 audio and should support MP4 AAC LC audio. While no
                video Core Media Types are defined in this version of EPUB, an{' '}
                <span className="phrase">
          ...
          >
            ...
            >
              ...
              <p>
                ...
                property, <code>dcterms:modified</code>, has been added. This
                new property contributes to the new solution to persistence in
              ...
              <p id="new-meta-elem">
                ...
                with a declarative term vocabulary association mechanism, as
                well as the ability to describe not only the Publication as a
                whole, but also individual resources and/or fragments within it.
                A set of EPUB-specific metadata properties has been added,
                allowing for example the identification of the Publication cover
                image, and sorting of related titles in the bookshelf.
              </p>
              <p>
                A new metadata{' '}
                <code>
                ...
                association of external supplementary metadata resources with
                the publication (e.g., ONIX or XMP records).
              </p>
            </section>
            <section
              className="section"
            ...
            >
              ...
              <p>
                The new <code>properties</code> attribute on the Package
                Document manifest <code>item</code> and spine{' '}
                <code>itemref</code> elements allows for the declaration of
                metadata about individual Publication Resources.
              </p>
              <p>
                {' '}
          ...
          >
            ...
            <p>
              ...
              <code>spine</code>. Publication Resources referenced from XHTML
              and SVG Content Documents and CSS must now be Core Media Types
              unless referenced in a context that provides{' '}
              <span className="phrase">
                <a href="epub30-publications.xhtml#sec-fallback-processing-flow">
          ...
          >
            ...
            >
              ...
              <p>
                ...
                the OCF Container). The implications of this change are more
                fully described in{' '}
                <a
          ...
          >
            ...
            <p>
              The referenced version of XML 1.0 is the fifth edition, which
              means that Unicode version 5.0.0 is now supported (OPS 2.0.1, via
              its use of XML 1.0 fourth edition, supported Unicode 2.0).
            </p>
          </section>
        </section>
        <section
        ...
        >
          ...
          <p>
            ...
            replace existing features in EPUB 2.0.1, and several features in
            EPUB 2.0.1 that were not widely adopted by content authors or
            Reading Systems are discontinued. Such features, from a content
            conformance perspective, are either{' '}
            <span className="italic">removed</span> (which means that conformant
            EPUB 3 content might not use the construct) or{' '}
            <span className="italic">deprecated</span> (which means that use of
            the construct in EPUB 3 is allowed but not recommended). Note that,
            in most cases, Reading Systems are still required to support these
            constructs for backwards compatibility reasons (as normatively
            stated in the relevant specifications).
          </p>
          <p>
          ...
          >
            ...
            >
              ...
              <p>
                ...
                capabilities of a similar nature to DTBook, DTBook is no longer
                an alternative syntax in EPUB 3.{' '}
              </p>
            </section>
            <section
              className="section"
            ...
            >
              ...
              <p>
                ...
                Reading Systems, and has been removed from EPUB 3. As a result
                the <code>item</code> element no longer has the{' '}
            ...
            >
              ...
              <p>
                ...
                defines a "Filesystem Container" abstraction. This change was
                made in conjunction with new restrictions in Publications 3.0
                restricting references to remote resources in EPUB Publications
                to specific media types and contexts. Taken together, these
                changes mean that the only instantiation of an EPUB Publication
                defined at this time is the EPUB ZIP Container, and that EPUB
                files must in general contain all constituent parts of the
                Publication, with certain well-defined exceptions.{' '}
              </p>
              <p>
                ...
                cross-domain resource loading restrictions in the browser
                security model and the potential for inadvertent interaction
                between script-based interactivity within EPUB 3 content and
                script-based Reading System implementations. Publishers and
                content distributors providing EPUB content are presently
                utilizing server-based software to manage these issues, in
                effect creating a distributed client-server Reading System in
                which a packaged EPUB file is ingested on a server and may be
                transformed en route to client software into whatever set of
                resources is convenient for that implementation. Consequently,
                there was no pressing requirement to define an interoperable
                distributed form of an EPUB Publication in order to meet the
                requirements of the Working Group charter.{' '}
              </p>
              <p>
                EPUB 2.x (via the OCF Filesystem container and by being
                relatively vague in the OPF specification about where absolute
                URLs were legal) can be considered to have incompletely
                described distributed publications without specifying
                conformance requirements for them. This was a combination of
                historical (with respect to OPF which was a revision to a
                predecessor specification that pre-dated any ZIP-based
                container) and aspirational (with respect to OCF) factors.{' '}
              </p>
              <p>
                ...
                from the EPUB 3 base specifications. The Working Group
                understands that networked Publications will be increasingly
                important, and expects future work to include development of
                robust interoperable conformance definitions for distributed
                EPUB Publications based on emerging content publisher and
          ...
          >
            ...
            >
              ...
              <p>
                ...
                Document <code className="literal">landmarks</code> feature.
                Refer to{' '}
                <span className="phrase">
                  <a href="epub30-contentdocs.xhtml#sec-xhtml-nav">
                    EPUB Navigation Documents
